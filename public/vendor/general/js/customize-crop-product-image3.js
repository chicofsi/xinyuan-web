$(document).ready(function(){
  ...
  $image_crop_image3 = $('#image_demo_image3').croppie({
    enableExif: true,
    viewport: {
      width:250,
      height:250,
  ...
  $('#upload_product_image3').on('change', function() {
    var reader = new FileReader();
    reader.onload = function (event) {
      $image_crop_image3.croppie('bind', {
    ...
    if (!validImageTypes.includes(fileType)) {
      ...
      if (fileSize > 3) {
        ...
        $('#uploadimageModal_image3').modal('show');
      }
    }
  });

  $('.crop_image_image3').click(function(event){
    ...
    $image_crop_image3.croppie('result', {
      type: 'canvas',
      size: 'viewport'
      ...
      $.ajax({
        ...
        {
          $('#uploadimageModal_image3').modal('hide');

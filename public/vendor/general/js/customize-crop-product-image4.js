$(document).ready(function(){
  ...
  $image_crop_image4 = $('#image_demo_image4').croppie({
    enableExif: true,
    viewport: {
      width:250,
      height:250,
  ...
  $('#upload_product_image4').on('change', function() {
    var reader = new FileReader();
    reader.onload = function (event) {
      $image_crop_image4.croppie('bind', {
    ...
    if (!validImageTypes.includes(fileType)) {
      ...
      if (fileSize > 3) {
        ...
        $('#uploadimageModal_image4').modal('show');
      }
    }
  });

  $('.crop_image_image4').click(function(event){
    ...
    $image_crop_image4.croppie('result', {
      type: 'canvas',
      size: 'viewport'
      ...
      $.ajax({
        ...
        {
          $('#uploadimageModal_image4').modal('hide');

<x-app-layout>
    ...
    <div class="page-heading">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"> Currency Profit & Loss</li>
        </ul>
    </div>
    <!-- page heading end-->
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <table  class="display table " id="purchase_table">
                                <thead>
                                    <tr>
                                        <th>
                                            Entry Date
    ...
    @section('script')
        ...
        <script>
            ...
            function getTables() {
                ...
                $.ajax({
                    type:"POST",
                    url: "{{ url('/dashboard/currency-profit-loss/list') }}",
                    data: { from: from, to: to},
                    dataType: 'json',
                    success: function(res){
                        $('#profittable').html(res.data);

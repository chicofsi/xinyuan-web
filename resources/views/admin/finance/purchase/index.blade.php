        ...
        <div class="state-info">
            <div class='btn-group'>
                ...
                <ul role='menu' class='dropdown-menu'>
                    <li><a href='{{ url('dashboard/finance/purchase/invoice/new') }}'>Purchase Invoice</a></li>
                    {{-- <li><a href='{{ url('dashboard/finance/purchase/quote/new') }}'>Purchase Quote</a></li>
                    <li><a href='{{ url('dashboard/finance/purchase/order/new') }}'>Purchase Order</a></li> --}}
                    {{-- <li class='divider'></li>
                ...
                <section class="panel">
                    <header class="panel-heading custom-tab dark-tab ">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#purchaseinvoice" data-toggle="tab">Purchase Invoice</a>
                            </li>
                            {{-- <li class="">
                                <a href="#purchasedelivery" data-toggle="tab">Purchase Delivery</a>
                            </li>
                            <li class="">
                                <a href="#purchaseorder" data-toggle="tab">Purchase Order</a>
                            </li>
                            <li class="">
                                <a href="#purchasequote" data-toggle="tab">Purchase Quote</a>
                            </li> --}}
                        </ul>
                    </header>
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="purchaseinvoice">
                                <div class="adv-table">
                                    <div class="row">
                                    ...
                                    <table  class="display table table-hover " id="purchase_invoice">
                                        <thead>
                                            <tr>
                                                <th>
                                                    Date
                                        ...
                                        <tbody>
                                            ...
                                            @if (empty($purchaseinvoices->purchase_invoices))
                                                <tr>
                                                    <td colspan="6">
                                                        No Items
                                                    </td>
                                            ...
                                            @endif
                                            @foreach ($purchaseinvoices->purchase_invoices as $val)
                                                <tr>
                                                    <td>
                                                        {{$val->transaction_date}}
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('dashboard/finance/purchase/invoice/') }}/{{$val->id}}"> Purchase Invoice #{{$val->transaction_no}}
                                                            </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td style="text-align: right;">
                                                        {{$val->remaining_currency_format}} 
                                                    </td>                                                    
                                                    <td style="text-align: right;">
                                                        {{$val->original_amount_currency_format}} 
                                                    </td>                                           
                                                    <td >
                                                        @if ($val->tags)
                            ...
                            {{-- 
                            <div class="tab-pane" id="purchasedelivery">
                                <div class="adv-table">
                                    <div class="row">
                                        <div class="col-md-8" style="padding: 10px">
                                        </div>
                                    ...
                                    <table  class="display table table-hover " id="purchase_delivery">
                                        <thead>
                                            <tr>
                                                <th>
                                                    Date
                                        ...
                                        <tbody>
                                            @if (empty($purchasedeliveries->purchase_deliveries))
                                                <tr>
                                                    <td colspan="6">
                                                        No Items
                                                    </td>
                                            ...
                                            @endif
                                            @foreach ($purchasedeliveries->purchase_deliveries as $val)
                                                <tr>
                                                    <td>
                                                        {{$val->transaction_date}}
                                                    </td>
                                                    <td>
                                                        Purchase Delivery #{{$val->transaction_no}}
                                                    </td>
                                                    <td>
                                                        {{$val->person->display_name}} 
                                                    </td>
                            ...
                            <div class="tab-pane" id="purchaseorder">
                                <div class="adv-table">
                                    ...
                                    <table  class="display table table-hover " id="purchase_invoice">
                                        ...
                                        <tbody>
                                            @if (empty($purchaseorders->purchase_orders))
                                                <tr>
                                                    <td colspan="6">
                                                        No Items
                                                    </td>
                                            ...
                                            @endif
                                            @foreach ($purchaseorders->purchase_orders as $val)
                                                <tr>
                                                    <td>
                                                        {{$val->transaction_date}}
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('dashboard/finance/purchase/order/') }}/{{$val->id}}"> Purchase Order #{{$val->transaction_no}}</a>
                                                    </td>
                                                    <td>
                                                        {{$val->person->display_name}} 
                                                    </td>
                            ...
                            <div class="tab-pane" id="purchasequote">
                                <div class="adv-table">
                                    <div class="row">
                                        <div class="col-md-8" style="padding: 10px">
                                        </div>
                                    ...
                                    <table  class="display table table-hover " id="purchase_quote">
                                        <thead>
                                            <tr>
                                                <th>
                                                    Date
                                        ...
                                        <tbody>
                                            @if (empty($purchasequotes->purchase_quotes))
                                                <tr>
                                                    <td colspan="6">
                                                        No Items
                                                    </td>
                                            ...
                                            @endif
                                            @foreach ($purchasequotes->purchase_quotes as $val)
                                                <tr>
                                                    <td>
                                                        {{$val->transaction_date}}
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('dashboard/finance/purchase/quote/') }}/{{$val->id}}"> Purchase Quote #{{$val->transaction_no}}</a>
                                                    </td>
                                                    <td>
                                                        {{$val->person->display_name}} 
                                                    </td>

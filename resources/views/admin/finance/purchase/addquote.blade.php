                ...
                <div class="panel-body invoice">
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            <h2 class="invoice-title" id="title">Create Purchase Quote</h2>
                        </div>
                    ...
                    <div class="invoice-address">
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <h4 class="inv-to" id="receiver">Vendor</h4>
    ...
    @section('script')
        ...
        <script>
            ...
            $('#formInvoice').submit(function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('/dashboard/finance/purchase/quote/new')}}",
                    data: form,
                    cache:false,
                    contentType: false,
                    processData: false,
            ...
            function detail(id){
                $.ajax({
                    type:"POST",
                    url: "{{ url('/dashboard/vendor/detail') }}",
                    data: { id: id },
                    dataType: 'json',
                    success: function(res){
                        ...
                        $('#id_level_change').val(res.vendorlevel.id);
                        ...
                        $('#AccountTempo').html(res.vendorlevel.tempo_limit);
                        $('#AccountLoanLimit').html(res.vendorlevel.loan_limit);
                        $('#AccountInvitedBy').html(res.purchase.name);
                        $('#AccountLevel').html(res.vendorlevel.level);

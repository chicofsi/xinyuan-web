                ...
                <div class="panel-body invoice">
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            <h2 class="invoice-title" id="title">Create Purchase Invoice</h2>
                        </div>
                    ...
                    <div class="invoice-address">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <h4 class="inv-to" id="receiver">Vendor Ref No </h4>
                                <input type="text" class="form-control" id="reference_no" placeholder="Enter Vendor Reference No">
    ...
    @section('script')
        ...
        <script>
            ...
            $('#formInvoice').submit(function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('/dashboard/finance/purchase/invoice/new')}}",
                    data: form,
                    cache:false,
                    contentType: false,
                    processData: false,

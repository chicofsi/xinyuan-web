<x-app-layout>
    ...
    <div class="page-heading">
        ...
        <div class="state-info">
            ...
            <a href="#TransactionModal" data-toggle="modal" onclick="add()" class=" btn btn-primary ">Create New Purchase <i class="fa fa-plus"></i></a>
        </div>
    </div>
    <!-- page heading end-->
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($purchaseinvoices->purchase_invoices as $val)
                                                <tr>
                                                    ...
                                                    <td>
                                                        Purchase Invoice #{{$val->transaction_no}}
                                                    </td>
                                                    <td>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($purchaseorders->purchase_orders as $val)
                                                <tr>
                                                    ...
                                                    <td>
                                                        Purchase Order #{{$val->transaction_no}}
                                                    </td>
                                                    <td>
                                                        {{$val->person->display_name}} 
                                                    </td>

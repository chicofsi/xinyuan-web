<x-app-layout>
    ...
    @section('script')
        ...
        <script>
            ...
            function getDetails() {
                var url="{{ url('/dashboard/finance/purchase/invoice/details/') }}"+"/"+{{$id}};
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        $('#title').html("Purchase Invoice #"+res.purchase_invoice.transaction_no);
                        $('#status').html(res.purchase_invoice.transaction_status.name);
                        $('#receiver').html("customer");
                        $('#receiver_name').html(res.purchase_invoice.person.display_name);
                        $('#address').html(res.purchase_invoice.shipping_address);
                        $('#email').html(res.purchase_invoice.email);
                        $('#transaction_date').html(res.purchase_invoice.transaction_date);
                        $('#due_date').html(res.purchase_invoice.due_date);
                        $('#term').html(res.purchase_invoice.term.name);
                        if(res.purchase_invoice.purchase_order){
                            $('#order_no').html(res.purchase_invoice.purchase_order.transaction_no);

                        }
                        $('#transaction_no').html(res.purchase_invoice.transaction_no);
                        $('#ref_no').html(res.purchase_invoice.reference_no);
                        $('#tags').html(res.purchase_invoice.tags);
                        $.each(res.purchase_invoice.transaction_lines_attributes,function (key, value) {
                        ...
                        $('#subtotal').html(res.purchase_invoice.subtotal_currency_format);
                        $('#Total_amount').html(res.purchase_invoice.original_amount_currency_format);
                        $('#payment_paid').html(res.purchase_invoice.payment_received_amount_currency_format);
                        $('#balance_due').html(res.purchase_invoice.credit_memo_balance_currency_format);
                    },
                    error: function(data){
                        console.log(data);
                    }

                ...
                <div class="panel-body invoice">
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            <h2 class="invoice-title" id="title">Create Sales Order</h2>
                        </div>
                    ...
                    <div class="invoice-address">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <input type="text" class="form-control" id="reference_no" placeholder="Enter Customer Reference No">
    ...
    @section('script')
        ...
        <script>
            ...
            $('#formOrder').submit(function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('/dashboard/finance/sales/order/new')}}",
                    data: form,
                    cache:false,
                    contentType: false,
                    processData: false,

<x-app-layout>
    ...
    <div class="page-heading">
        ...
        <div class="state-info">
            ...
            <a href="{{ url('dashboard/finance/expenses/new') }}"  onclick="add()" class=" btn btn-primary ">Create New Expense <i class="fa fa-plus"></i></a>
        </div>
    </div>
    <!-- page heading end-->
                                ...
                                <div class="adv-table">
                                    ...
                                    <table  class="display table table-hover " id="customer_table">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                            @foreach ($expenses->expenses as $val)
                                                <tr>
                                                    <td>
                                                        {{$val->transaction_date}}
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('dashboard/finance/expenses/') }}/{{$val->id}}"> Expense #{{$val->transaction_no}}</a>
                                                    </td>
                                                    <td>
                                                        {{$val->account_category}} 
                                                    </td>
                                                    <td>
                                        ...
                                        <tbody>
                                            {{-- @foreach ($purchaseinvoices->purchase_invoices as $val)
                                                <tr>
                                                    ...
                                                    <td>
                                                        Sales Invoice #{{$val->transaction_no}}
                                                    </td>
                                                    <td>
                                                        {{$val->person->display_name}} 
                                                    </td>

...
namespace App\Http\Controllers\Admin\PurchasePayment;
...
class ManagePurchasePayment extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.purchase.payment',compact('product','factories','accounts'));
        ...
        if($purchase->isEmpty()){
            ...
            foreach ($purchase as $key => $value) {
                ...
                $data.= "<tr>
                            ...
                            <td>".$value->currency->symbol.number_format(intval($value->paid), 0, ',', ',')."</td>
                            <td>".$value->currency->symbol.number_format($debt, 0, ',', ',')."</td>

...
class ManageGrossWeight extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax()) {
            return datatables()->of(ProductGrossWeight::select('*'))
        ...
        return view('admin.product.grossweight');
    ...
    {
        $grossweightId = $request->id;
 
        $grossweight   =   ProductGrossWeight::updateOrCreate(
                    [
                     'id' => $grossweightId
                    ],
                    [
        ...
        return Response()->json($grossweight);
    ...
    public function edit(Request $request)
    {
        ...
        $grossweight  = ProductGrossWeight::where($where)->first();
    ...
    public function destroy(Request $request)
    {
        ...
        $grossweight=ProductGrossWeight::where('id',$request->id)->delete();
